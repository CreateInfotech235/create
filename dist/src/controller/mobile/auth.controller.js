...
const getSupportTicket = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield SupportTicket_1.default.aggregate([
            ...
            {
                $project: Object.assign(Object.assign({ _id: 1, subject: 1, problem: 1, problemSolved: 1 }, (!isSendMessage ? { messages: 1 } : {})), { createdAt: 1, updatedAt: 1, adminId: { name: '$adminDetails.name', email: '$adminDetails.email' } }),
            },
        ]);
        console.log('data', data);
...
const addMessageToTicket = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        index_1.io.to(ticketId).emit('Messagedataupdate', {
            unreadMessages: yield (0, unreadMessages_1.unreadMessages)(ticket[0].userid.toString(), 'merchant'),
        });
...
const deleteMessageFromTicket = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        index_1.io.to(ticketId).emit('messageDelete', { messageId });
        res.status(200).json({ message: 'Message deleted successfully' });
    }
    catch (error) {
